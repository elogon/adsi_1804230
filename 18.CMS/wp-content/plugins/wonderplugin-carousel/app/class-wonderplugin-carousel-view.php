...
class WonderPlugin_Carousel_View {
	...
	function print_overview() {
		...
		<h2><?php echo __( 'Wonder Carousel', 'wonderplugin_carousel' ) . ( (WONDERPLUGIN_CAROUSEL_VERSION_TYPE == "C") ? " Commercial Version" : " Free Version") . " " . WONDERPLUGIN_CAROUSEL_VERSION; ?> </h2>
