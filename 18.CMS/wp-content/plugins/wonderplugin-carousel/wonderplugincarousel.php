...
define('WONDERPLUGIN_CAROUSEL_VERSION', '15.2');
...
define('WONDERPLUGIN_CAROUSEL_PLUGIN_VERSION', '15.2');
...
class WonderPlugin_Carousel_Plugin {
	...
	function register_menu()
	{
		...
		$menu = add_menu_page(
				__('Wonder Carousel', 'wonderplugin_carousel'),
				__('Wonder Carousel', 'wonderplugin_carousel'),
				$userrole,
